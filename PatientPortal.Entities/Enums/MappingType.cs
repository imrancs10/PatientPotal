//-----------------------------------------------------------------------
// <copyright file="MappingType.cs" company="Company" author="Nagarro">
//  All rights reserved. Copyright (c) 2016.
// </copyright>
// <summary>This is the MappingType.cs file.</summary>
//-----------------------------------------------------------------------
namespace PatientPortal.Entities
{
    ...
    public enum MappingType
    {
        ...
        /// <summary>
        /// All the properties of Data object will be mapped to entity object which has skip mapping to false.
        /// </summary>
        TotalImplicit,
