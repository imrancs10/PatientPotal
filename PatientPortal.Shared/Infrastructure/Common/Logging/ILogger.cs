//-----------------------------------------------------------------------
// <copyright file="ILogger.cs" company="Company" author="Nagarro">
//  All rights reserved. Copyright (c) 2013.
// </copyright>
// <summary>This is the ILogger class.</summary>
//-----------------------------------------------------------------------
...
namespace PatientPortal.Shared.Infrastructure.Common.Logging
{
    ...
    /// <summary>
    /// Defines the contract for implementing Logger using particular library (ex: NLog, Log4Net, etc.)    
    /// </summary>
