//-----------------------------------------------------------------------
// <copyright file="Logger.cs" company="Company" author="Nagarro">
//  All rights reserved. Copyright (c) 2013.
// </copyright>
// <summary>This is the Logger class.</summary>
//-----------------------------------------------------------------------

namespace PatientPortal.Shared.Infrastructure.Common.Logging
{
    using System;

    /// <summary>
    /// Represents the abstract base class for all Logger implementations.
    /// DEV NOTE: 
    /// 1. Since IoC conatiner is being used to resolve dependencies, the implementations must be registered as singleton object.
    /// </summary>
